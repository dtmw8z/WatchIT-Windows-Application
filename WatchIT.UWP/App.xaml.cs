...
namespace WatchIT.UWP
{
    ...
    {
        static string SqlConnectionString = "Server=localhost;Initial Catalog=watch-it; Integrated Security = True; Connect Timeout = 30;";
        public static IUnitOfWork UnitOfWork { get; set; }
        public static UserViewModel userViewModel { get; set; }
        public static MusicViewModel musicViewModel { get; set; }
        public static VideoViewModel videoViewModel { get; set; }
        public static ChannelViewModel channelViewModel { get; set; }
        public static UserSubscribesChannelViewModel userSubscribesChannelViewModel { get; set; }
        ...
        {
            DbContextOptionsBuilder<WatchitDbContext> dbcob =
                new DbContextOptionsBuilder<WatchitDbContext>();
